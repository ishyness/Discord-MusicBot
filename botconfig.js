module.exports = {
  Admins: ["1001781433385365526"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/63A5DSP5ZZ", // Support Server Link
  Token: process.env.Token || "MTAzMzAwMDgzNDYzMzU4MDU3NA.G3AHZX.5qHlEMZqu9n4bdcwPML3i-ckEMsmMQmhXm_MRg", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1033000834633580574", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "3wjl9fkkBjxKCXW7C44xY-cUJovpJKFY", // Discord Client Secret
  ...
  Presence: {
    ...
    type: "PLAYING", // PLAYING, WATCHING, LISTENING, STREAMING trạng thái
  },
